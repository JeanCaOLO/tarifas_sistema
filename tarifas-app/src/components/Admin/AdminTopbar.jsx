    ...
    <div className="topbar">
      <div className="inner">
        ...
        <nav className="tabs">
          ...
          <button className={`tab ${tab === 'volumen' ? 'active' : ''}`} onClick={() => setTab('volumen')}>📦 Comparativo Volumen</button>
          <button className={`tab ${tab === 'config' ? 'active' : ''}`} onClick={() => setTab('config')}>⚙ Configuración</button>
          {etapa === '2' && (
