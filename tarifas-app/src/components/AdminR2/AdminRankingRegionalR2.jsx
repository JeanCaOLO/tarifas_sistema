...
export default function AdminRankingRegionalR2() {
  ...
  const resultado = calcularRankingRegionalR2(tarFilt, respFilt, { formRegion, campo, regionesIncluidas: regionesArr, volumenes })
  ...
  return (
    <section>
      ...
      <div className="section-title">Nota Final R2 por Oferente (por posición)</div>
      <div className="card" style={{ padding: '8px 14px', marginBottom: 8, fontSize: 11.5, color: 'var(--muted)' }}>
        La Nota Final se calcula por <b>puesto por país</b>: 1º = 100 pts, 2º = 80, 3º = 60, 4º = 40, 5º = 20…, ponderado por el peso de cada país. El score de costo queda como dato informativo en el tooltip.
      </div>
